...
class GNNRegressor(torch.nn.Module):
    def __init__(self, input_dim, embedding_dim, hidden_output_dim, transformer_heads=1, graph_layer_type="gcn", predictor="linear"):
        super().__init__()
